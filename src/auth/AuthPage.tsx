...
export default function AuthPage() {
    ...
    useEffect(() => {
        // Show message if there's one in the URL
        ...
        if (user) {
            ...
            // Check for pending onboarding completion
            const pendingOnboardingCompletion = localStorage.getItem('pendingOnboardingCompletion');
            if (pendingOnboardingCompletion) {
                navigate('/onboarding?completing=true');
                return;
            }
